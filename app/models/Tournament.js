...
const  setTemplate = JSON.parse( fs.readFileSync(path.resolve("./app/models/jsonTemplates/setTemplate.json")));
const  gameTemplate = JSON.parse( fs.readFileSync(path.resolve("./app/models/jsonTemplates/gameTemplate.json")));
const { players } = JSON.parse( fs.readFileSync("./app/constants/players.json"))
